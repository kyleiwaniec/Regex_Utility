 ...
 */
public class BinarySearchTree<E extends Comparable<E>>  extends BinaryTree<E> implements BinarySearchTreeInt<E>{
    // Data Fields
    ...
    * @return The node with the smallest key, null if tree is empty
    */
    @Override
    public E getMin() {
        return getMin(root);
    ...
    * @return The node with the largest key, null if tree is empty
    */
    @Override
    public E getMax(){
        return getMax(root);
    }
    private E getMax(Node<E> localRoot){
        if(localRoot == null){
            return null;
        }else{
...
// Insert solution to programming exercise 2, section 4, chapter 6 here
   // (removeMin, findSmallestChild) I don't think this is neccessary.
